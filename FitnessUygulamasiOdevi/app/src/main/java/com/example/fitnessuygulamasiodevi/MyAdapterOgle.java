...
public class MyAdapterOgle extends RecyclerView.Adapter<MyAdapterOgle.MyViewHolder> {
    ...
    public MyAdapterOgle(Context context, ArrayList<Ogle> list, ClickDelegate2 clickDelegate) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new MyViewHolder(LayoutInflater.from(context).inflate(R.layout.ogle_item,parent,false),clickDelegate);
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(@NonNull View itemView,ClickDelegate2 clickDelegate) {
            super(itemView);
            ...
            itemView.findViewById(R.id.arttir_ogle).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
